...
function update_sensibilities() {
    ...
    if (current == 0) {
        ...
        img_first.setAttribute("class", "disabled");
        img_previous.setAttribute("class", "disabled");
    } else {
        ...
        img_first.setAttribute("class", "enabled");
        img_previous.setAttribute("class", "enabled");
    }
    ...
    if (current == images.length - 1) {
        ...
        img_next.setAttribute("class", "disabled");
        img_last.setAttribute("class", "disabled");
    } else {
        ...
        img_next.setAttribute("class", "enabled");
        img_last.setAttribute("class", "enabled");
    }
}
...
function display_current() {
    ...
    if (types[current] == 'image') {
        main_img.innerHTML = '<div class="fullscreen_image"><img style="width:' + widths[current] + 'px;height:' + heights[current] + 'px" src="' + images[current] + '"/></div>';
    } else {
